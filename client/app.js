...
const roleDescriptions = {
    ...
    illusionist: {
        name: 'Иллюзионист',
        passive: 'Мираж – 20% шанс создать иллюзию и полностью избежать урона.',
        active: 'Зазеркалье – заставляет врага атаковать самого себя, нанося себе 100% урона от своей атаки.'
    }
};
