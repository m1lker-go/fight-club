...
berserker: {
    name: 'Берсерк',
    passive: 'Ярость – чем меньше HP, тем выше урон. Каждая атака наносит 16% от текущего урона себе (не убивает).',
    active: 'Кровопускание – теряет 50% от макс. HP (минимум 1 HP), затем наносит урон ×2 от атаки.'
},
    knight: {
    name: 'Рыцарь',
    ...
    assassin: {
        name: 'Убийца',
        passive: 'Смертельное касание – критический урон 250% вместо 150%.',
    ...
    blood_hunter: {
        ...
        passive: 'Вампиризм – усиливает вампиризм на 20% от нанесённого урона.',
