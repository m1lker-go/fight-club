...
const roleDescriptions = {
   ...
   guardian: {
    name: 'Страж',
    passive: 'Живой щит – Увеличивает защиту на +10 единиц (Макс. 80), 20% шанс блока.',
    active: 'Несокрушимость – Восстанавливает 20% от максимального HP. Снимает отрицательные эффекты.'
},
berserker: {
    name: 'Берсерк',
    passive: 'Ярость – Чем меньше HP, тем выше урон. Каждая атака наносит 16% от текущего урона себе (Не может себя убить).',
    active: 'Кровопускание – Теряет 60% от текущего злоровья (Не может себя убить). Получает +50% Крит.урона и наносит гарантированный Крит.удар.'
},
    knight: {
    name: 'Рыцарь',
