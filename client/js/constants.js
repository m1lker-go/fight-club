...
const roleDescriptions = {
 ...
 berserker: {
    name: 'Берсерк',
    passive: 'Кровавая ярость – чем меньше HP, тем выше урон (до +50% при HP < 20%). Каждая атака наносит себе 10% от показателя атаки.Не может себя убить.',
    active: 'Кровопускание – жертвует 30% от максимального HP. Не может себя убить. Затем наносит урон x3 от атаки.'
},
    knight: {
    name: 'Рыцарь',
