...
const roleDescriptions = {
    ...
    guardian: {
        name: 'Страж',
        passive: 'Живой щит – Защита +5 (макс. 75), 10% шанс блока.',
        active: 'Несокрушимость – Восстанавливает 20% HP. Снимает все негативные эффекты.'
    },
    berserker: {
        name: 'Берсерк',
        passive: 'Ярость – Чем меньше HP, тем выше урон и шанс крита. Самоурон 10% от наносимого урона.',
        active: 'Кровопускание – Теряет 30% текущего HP. Гарантированный крит, +50% крит. урона.'
    },
    knight: {
        name: 'Рыцарь',
    ...
    venom_blade: {
        ...
        passive: 'Ядовитый укус – Атака накладывает яд (макс. 5). Урон в конце раунда: 2 + ловкость/5 за стак.',
        active: 'Ядовитая волна – Чистый урон: атака + урон от всех стаков (2 + ловкость/5 за стак) + бонус за сжигание (5→30). Игнорирует защиту, отражение и вампиризм.'
    },
    blood_hunter: {
    ...
    pyromancer: {
        name: 'Поджигатель',
        passive: 'Горящие души – Атака поджигает (макс. 5). Урон в конце раунда: 2 + ловкость/5 за стак.',
        active: 'Огненный шторм – Урон: интеллект×1.8 + стаки×2, сжигает стаки.'
    },
    cryomancer: {
        name: 'Ледяной маг',
        passive: 'Ледяная кровь – Атака накапливает стак холода. 3 стака = заморозка на 1 ход.',
        active: 'Вечная зима – Урон: интеллект×1.6 (×2.5 если цель заморожена). Замораживает цель на 1 ход.'
    },
    illusionist: {
        name: 'Иллюзионист',
        passive: 'Мираж – Гарантированный уворот каждый 4-й ход.',
        active: 'Зазеркалье – Враг атакует себя. Урон = его атака × 2 × (1 + Инт/100), минимум 12.'
    }
};
