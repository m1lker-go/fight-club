...
const roleDescriptions = {
 ...
 pyromancer: {
    name: 'Поджигатель',
    passive: 'Горящие души – каждая атака поджигает цель (макс. 5 стаков). В конце хода огонь наносит урон = стаки ×2 (игнорирует защиту).',
    active: 'Огненный шторм – наносит урон (интеллект×2.5 + стаки×2) и сжигает все стаки.'
},
  cryomancer: {
    name: 'Ледяной маг',
    passive: 'Ледяная кровь – каждая атака накапливает стак холода. При 3 стаках цель замораживается на 1 ход.',
    active: 'Вечная зима – наносит урон (интеллект×2, ×3 если цель заморожена) и замораживает цель.'
},
    illusionist: {
        name: 'Иллюзионист',
