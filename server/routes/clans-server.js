...
const forbiddenWords = [
  ...
  // Дополнительные русские бранные слова
  ...
  'хуйло', 'цицка', 'член', 'яйца', 'мудило', 'мудозвон', 'пердун', 'срач', 'срун', 'очко', 'шмар',

  // Английские бранные слова
  ...
  // Обидные прозвища и оскорбления (распространенные в интернете)
  ...
  // Различные комбинации и сокращения (англ.)
  'wtf', 'stfu', 'gtfo', 'fml', 'fuk', 'fck', 'fvck', 'phuck', 'sh1t', 'sh*t', 'b1tch', 'b*tch',
  'c0ck', 'c*nt', 'd1ck', 'd*ck', 'p0rn', 'pr0n', 'p*rn', 'a55', 'a$$', 'a*s', 'a-hole', 'ass',

  // Дополнительные русские (включая вариации с заменами букв, но базовые формы)
  'еб', 'еба', 'ебу', 'ебё', 'ебл', 'ебн', 'ёб', 'йоб', 'йоба', 'ёба', 'ёбн', 'ёбарь', 'йопта',
  'ёпта', 'ёкарный', 'ёклмн', 'ёксель', 'ёпрст', 'ёшкин', 'йод', 'ху', 'хую', 'хуя', 'хуюшки',
  'хреновина', 'хреново', 'хрень', 'пизд', 'пизде', 'пиздю', 'пиздя', 'пизж', 'пизжен', 'пиздатый',
  'пиздануть', 'пиздануться', 'пиздеть', 'пиздишь', 'пиздюк', 'пиздюля', 'пиздюшник', 'пиздопроёбина',
  'блядки', 'блядство', 'блядовать', 'блядун', 'блядюга', 'блядюшка', 'бля', 'блин' (в контексте мата,
  но 'блин' иногда заменяет 'бля', поэтому можно добавить), 'ёж', 'ёжкин', 'ёженька', 'ёпт', 'ёптить',

  // Еще распространенные английские сленговые ругательства
